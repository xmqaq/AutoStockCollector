...
import type { AICallStats } from '@/api/aiCallHistory'
...
.stat-total .stat-value { color: var(--el-color-primary, #409eff); }
.stat-success .stat-value { color: var(--el-color-success, #67c23a); }
.stat-fail .stat-value { color: var(--el-color-danger, #f56c6c); }
</style>
