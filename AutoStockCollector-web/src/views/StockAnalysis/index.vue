      ...
      <el-card shadow="never" class="sa-card">
        ...
        <div class="sa-dims">
          <div v-for="d in dims" :key="d.key" class="sa-dim">
            ...
            <el-progress :percentage="result.scores[d.key]" :color="scoreColor(result.scores[d.key])" :show-text="false" />
            <span class="sa-dim-val">{{ result.scores[d.key].toFixed(0) }}</span>
          </div>
        </div>
