SECTOR_SYNTHESIS_PROMPT = """你是一名资深 A 股行业研究员。以下是近期关于 **{sector}** 板块的 {total} 篇研究报告标题列表，以及部分报告的 AI 摘要。
...
注意：评级统计是静态评级水平分布（买入/增持 vs 减持/卖出），不是评级变化方向。
...
- **summary**: 对该板块的综合研判，请结合 AI 摘要中的核心观点和盈利预测
